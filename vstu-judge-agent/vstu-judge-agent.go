...
const (
    AgentIdentificationEnvironmentKey    = "VSTU_JUDGE_AGENT_ID"
    ExtraConfigurationFileEnvironmentKey = "VSTU_JUDGE_AGENT_CONFIGURATION"
)

const (
    ConfigurationFileName = "vstu-judge-agent-configuration.json"
